        ...
        if 'cuda' in device:
            if path_to_detector is None:
                ...
                if not os.path.isfile(path_to_detector):
                    ...
                    #request_file.urlretrieve("https://www.adrianbulat.com/downloads/dlib/mmod_human_face_detector.dat", os.path.join(path_to_temp_detector))
                    shutil.move("core/face_alignment/checkpoints/mmod_human_face_detector.dat", os.path.join(path_to_temp_detector))
