...
"""
models_paths = {
    '2DFAN-4': 'core/face_alignment/checkpoints/2DFAN4-11f355bf06.pth.tar',
    '3DFAN-4': 'core/face_alignment/checkpoints/3DFAN4-7835d9f11d.pth.tar',
    'depth': 'core/face_alignment/checkpoints/depth-2a464da4ea.pth.tar',
}
...
class FaceAlignment:
    def __init__(self, landmarks_type, network_size=NetworkSize.LARGE,
        ...
        #face_detector_module = __import__('.detection.' + face_detector, globals(), locals(), [face_detector], 0)
        ...
        fan_weights = torch.load(models_paths[network_name], map_location=lambda storage, loc: storage)
